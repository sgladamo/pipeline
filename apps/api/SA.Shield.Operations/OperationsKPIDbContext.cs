...
{
    internal class OperationsKPIDbContext : DbContext
    {
        public DbSet<KPIMRPForecastMadeIn> KPIMRPForecasts { get; set; }

        public DbSet<KPIWIPCompleteJobs> KPIWIPCompleteJobs { get; set; }
